...
<div class="security_content" style="width: 1200px">
    <div class="security-left">
        ...
        <ul class="security-list">
            ...
            <li>
                <a href="studCourseGradeNotHaven.jsp"  class="">
    ...
    <div class="security-right" style="width: 1046px">
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 120px;text-align: center">课程成绩</th>
             <%--   <th style="width: 100px;text-align: center">不服</th> --%>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${courseSelected}" var="hne">
                ...
                <tr  style="height: 70px">
                        ...
                        <%--    <input type="hidden" name="teacher_name" value="${hne.teacherName}">
                            <button class="btn btn-primary btn-sm" onclick="submit()">不服</button></td>  --%>
                  </tr>
                </form>
            </c:forEach>
            <%--<tr style="height: 70px">--%>
