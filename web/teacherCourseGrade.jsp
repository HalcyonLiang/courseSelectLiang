...
<div class="security_content" style="width: 1200px">
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">我的课程</span>
        </div>
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 100px;text-align: center">登记成绩</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${mycourseList}" var="hne">
                <form method="post" action="teachercourseSelectStudent.do">
                <tr  style="height: 70px">
                        <td style="vertical-align: middle">${hne.courseName}</td>
                        <td style="vertical-align: middle">${hne.courseDept}</td>
                        <td style="vertical-align: middle">${hne.courseContent}</td>
                        <td style="vertical-align: middle">${hne.courseWeek}</td>
                        <td style="vertical-align: middle">${hne.courseLesson}</td>
                        <td style="vertical-align: middle"><input type="hidden" name="course_id" value="${hne.courseID}">
                            <input type="hidden" name="teacher_id" value="${hne.teacherID}">
                            <input type="hidden" name="isGrade" value="true">
                            <button class="btn btn-primary btn-sm" onclick="submit()">登记成绩</button></td>
                  </tr>
                </form>
            </c:forEach>
            <%--<tr style="height: 70px">--%>
