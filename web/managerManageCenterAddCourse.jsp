...
<body>
<jsp:include page="managerNavbar.jsp" flush="true" />
<div class="security_content" style="width: 1200px">
    <div class="security-left">
        ...
        <ul class="security-list">
            <li>
                <a href="managerManageCenter.jsp" >
                    <i class="al-1 current"></i>
                    <span>添加学生</span>
                </a>
            </li>
            <li>
                <a href="managerManageCenterAddTeacher.jsp" >
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">添加课程</span>
        </div>
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 280px;text-align: center">课程描述</th>
                <th style="width: 80px;text-align: center">课程周次</th>
                <th style="width: 80px;text-align: center">课程课节</th>
                <th style="width: 80px;text-align: center">教师姓名</th>
                <th style="width: 100px;text-align: center">添加</th>
            </tr>
            </thead>
            <tbody>
                <form method="post" action="studentAdd.do">
                <tr  style="height: 70px" class="ys">
                        <td style="vertical-align: middle"><input type="text" name="course_name"   size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="course_dept" size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="course_content" size="12"></td>
                        <td style="vertical-align: middle"><input type="text" name="course_week" size="8"></td>
                        <td style="vertical-align: middle"><input type="text" name="course_lesson" size="8"></td>
                        <td style="vertical-align: middle">
                            <select name="teacher_name">
                            <c:forEach items="${teacher}" var="hne">
                                <option value="${hne.teacherName}">${hne.teacherName}</option>
                            </c:forEach>

                             <td style="vertical-align: middle">

                            <button class="btn btn-primary btn-sm" onclick="submit()">添加</button></td>
                  </tr>
                </form>
...
<%
    }else if(info == "学生信息已经在数据库中")
    {
%>
<script type="text/javascript">
    window.alert("学生信息已经在数据库中");
</script>
<%
