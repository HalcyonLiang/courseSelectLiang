...
<div class="security_content" style="width: 1200px">
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">添加教师</span>
        </div>
        <div style="overflow-y: auto;height: 560px;margin-right: 58px">
        <table class="homeworkTable table table-striped">
            <thead>
            <tr>
                <th style="width: 120px;text-align: center">教师姓名</th>
                <th style="width: 120px;text-align: center">教师账号</th>
                <th style="width: 360px;text-align: center">教师密码</th>

                <th style="width: 100px;text-align: center">添加</th>
            </tr>
            </thead>
            <tbody>
                <form method="post" action="teacherAdd.do">
                <tr  style="height: 70px" class="ys">
                        <td style="vertical-align: middle"><input type="text" name="teacher_name"   size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="teacher_account" size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="teacher_password" size="15"></td>
...
<%
    }else if(info == "教师信息已经在数据库中")
    {
%>
<script type="text/javascript">
    window.alert("教师信息已经在数据库中");
</script>
<%
