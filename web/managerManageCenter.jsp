...
<div class="security_content" style="width: 1200px">
    <div class="security-left">
        ...
        <ul class="security-list">
            ...
            <li>
                <a href="managerManageCenterAddCourse.jsp" >
                    <i class="al-2"style="background-position:-39px -31px;"></i>
                    <span>添加课程</span>
                </a>
            </li>
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">添加学生</span>
        </div>
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 120px;text-align: center">学生账号</th>
                <th style="width: 360px;text-align: center">学生密码</th>
                <th style="width: 80px;text-align: center">学生班级</th>
                <th style="width: 80px;text-align: center">学生性别</th>
            ...
            <tbody>
                ...
                <tr  style="height: 70px" class="ys">
                        <td style="vertical-align: middle"><input type="text" name="stud_name"   size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="stud_account" size="10"></td>
                        <td style="vertical-align: middle"><input type="text" name="stud_password" size="15"></td>
                        <td style="vertical-align: middle"><input type="text" name="stud_className" size="8"></td>
                        <td style="vertical-align: middle"><input type="text" name="stud_sex" size="8"></td>
