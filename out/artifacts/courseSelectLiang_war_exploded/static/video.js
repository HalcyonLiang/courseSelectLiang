...
function sendVideoTestData(bufferTime,msg){
  var speed="1.0x",fullscreen=0, cdn="",renderingMode=1;
  
  var arr=[2,1,0];
  var currentHd=thePlayer.getCurrentQuality();
  var index=arr[currentHd];
  var videoUrl=mediaData.mpath[index];
    if(thePlayer.getRenderingMode()=="html5"){
        renderingMode=0;
        //var speedStr=document.getElementById('speedTxt').innerText?String(document.getElementById('speedTxt').innerText):String(document.getElementById('speedTxt').textContent);
