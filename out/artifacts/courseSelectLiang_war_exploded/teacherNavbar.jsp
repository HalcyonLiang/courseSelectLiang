...
<div id="header" class="navbar" style="margin-bottom: 0px;">
    <div class="page-container" id="nav">
        ...
        <ul class="nav-item l">
            <li><a href="instAccountSecure.jsp" target="_self">个人资料</a></li>
            <li><a href="teacherCourseCenter.jsp" target="_self">选课中心</a></li>
            <li><a href="teacherCourseGrade.jsp" target="_self">登记成绩</a></li>
        </ul>
        <div id="login-area">
