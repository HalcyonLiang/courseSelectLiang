...
<div class="security_content" style="width: 1200px">
    <div class="security-left">
        ...
        <ul class="security-list">
            <li>
                <a href="teacherCourseGrade.jsp" class="">
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">登记成绩</span>
        </div>
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 360px;text-align: center">学生...</th>
                <th style="width: 80px;text-align: center">学生...</th>
                <th style="width: 100px;text-align: center">成绩</th>
                <th style="width: 80px;text-align: center">登记</th>
            </tr>
            </thead>
            <tbody>
           <c:forEach items="${studentList}" var="hne">
                <form method="post" action="teacherCommitGrade.do">
                <tr  style="height: 70px">
                        <td style="vertical-align: middle">${hne.studName}</td>
                        <td style="vertical-align: middle">男</td>
                        <td style="vertical-align: middle">哈哈</td>
                        <td style="vertical-align: middle">哈哈</td>
                        <td style="vertical-align: middle"><input type="text" size="8" name="grade" value="${hne.grade}"></td>
                        <td style="vertical-align: middle">
                            <input type="hidden" name="stud_id" value="${hne.studID}">
                            <button class="btn btn-primary btn-sm" onclick="submit()">登记</button></td>
                  </tr>
                </form>
            </c:forEach>
            <%--<tr style="height: 70px">--%>
