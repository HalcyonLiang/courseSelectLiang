...
<div class="security_content" style="width: 1200px">
    <div class="security-left">
        ...
        <ul class="security-list">
            ...
            <li>
                <a href="studCourseSelected.jsp"  class="">
    ...
    <div class="security-right" style="width: 1046px">
        <div class="sr-t">
            <span class="tit-b"></span> <span class="acc-sec">可选择课程</span>
        </div>
        ...
        <table class="homeworkTable table table-striped">
            ...
            <tr>
                ...
                <th style="width: 100px;text-align: center">选择</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${courseAllList}" var="hne">
                ...
                <tr  style="height: 70px">
                        ...
                        <td style="vertical-align: middle">${hne.teacherName}</td>
                        ...
                        <td style="vertical-align: middle"><input type="hidden" name="course_id" value="${hne.courseID}">
                            <input type="hidden" name="teacher_name" value="${hne.teacherName}">
                            <button class="btn btn-primary btn-sm" onclick="submit()">选择</button></td>
                  </tr>
                </form>
            </c:forEach>
            <%--<tr style="height: 70px">--%>
